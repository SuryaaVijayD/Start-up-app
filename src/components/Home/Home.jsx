...
const Home = () => {
  ...
  return (
    <div id='Home' className='flex flex-col justify-center px-4 md:px-20 containers relative'>
        ...
        <div className='hidden md:flex flex-row mt-20 ml-12'>
        ...
        <h1 className=' dancing-style absolute text-shadow large-web-text-3'>AI</h1>
